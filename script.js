// R0331 Javascript Syksy 2020 Toisen projektin JavaScript-koodi
...
function loadData() {
    ...
    var url = "http://www.webcal.fi/cal.php?id=2&format=json&start_year=current_year&end_year=current_year&tz=Europe%2FHelsinki";
